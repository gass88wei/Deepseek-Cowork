    ...
    async createSession(name, workDirPath, options = {}) {
        ...
        if (existingSessionInfo?.sessionId) {
            ...
            if (existingSession) {
                ...
                // 确保 workDirIndex 映射存在
                if (existingSessionInfo.workDir) {
                    const normalizedPath = this._normalizePathForIndex(existingSessionInfo.workDir);
        ...
        try {
            ...
            if (oldWorkDir) {
                ...
                if (oldNormalizedPath !== normalizedPath && this.workDirIndex[oldNormalizedPath] === name) {
                    ...
                    logInfo(`Cleaned up old workDirIndex entry: ${oldNormalizedPath}`);
                }
            }
