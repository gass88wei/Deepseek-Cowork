...
import { l as logger, p as projectPath, d as backoff, e as delay, R as RawJSONLinesSchema, f as AsyncLock, c as configuration, g as readDaemonState, h as clearDaemonState, b as packageJson, r as readSettings, i as readCredentials, j as encodeBase64, u as updateSettings, k as httpClient, m as ApiKeyAuthError, n as encodeBase64Url, o as decodeBase64, w as writeCredentialsLegacy, q as writeCredentialsDataKey, s as acquireDaemonLock, t as writeDaemonState, A as ApiClient, v as releaseDaemonLock, x as clearCredentials, y as clearMachineId, z as getLatestDaemonLog } from './types-2X3BxmSO.mjs';
...
(async () => {
  ...
  if (subcommand === "doctor") {
    ...
    try {
      const { runCodex } = await import('./runCodex-Cq2Ylwil.mjs');
    ...
    try {
      const { runGemini } = await import('./runGemini-CLyi6TAg.mjs');
      let startedBy = void 0;
      for (let i = 1; i < args.length; i++) {
        if (args[i] === "--started-by") {
          startedBy = args[++i];
